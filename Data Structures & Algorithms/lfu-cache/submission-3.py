class Node:
    def __init__(self, key: int, value: int) -> None:
        ...
        self.bucket: "FrequencyBucket | None" = None
...
class LFUCache:
    def __init__(self, capacity: int) -> None:
        ...
        self.minimum: FrequencyBucket | None = None
        self.frequencies: dict[int, FrequencyBucket] = {}
    ...
    def get_or_create_bucket(self, frequency: int) -> FrequencyBucket:
        bucket = self.frequencies.get(frequency)

        if bucket is None:
            bucket = FrequencyBucket(frequency)
